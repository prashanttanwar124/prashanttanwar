  ...
  <div class>
    ...
    <vs-dialog overflow-hidden not-center v-model="activeModel">
      ...
      <div class="uk-card-body uk-margin-small-top uk-width-large uk-margin-medium-top uk-padding-remove-top uk-padding-remove-bottom">
        <vs-input v-model="form.category_name" class="labelYes" label="Category Name" :readonly="deleteBtn" @keyup="slugConvert">
        ...
        <div class="uk-margin-medium-top uk-width-1-1@m">
          <vs-input readonly v-model="form.slug" class="labelYes" label="Category Slug">
            <template #message-danger>
        ...
        <div class="uk-margin-medium-top uk-width-1-1@m">
          <vs-input type='number' v-model="form.position" class="labelYes" label="Position">
            <template #message-danger>
...
export default {
  ...
  methods: {
    ...
    editData() {
      this.form
        .put(`/data/category/${this.form.id}`)
        .then(res => {
          this.form.reset();
          this.activeModel = false;
          this.getData();
    ...
    deleteData() {
      this.form
        .delete(`/data/category/${this.form.id}`)
        .then(res => {
          this.form.reset();
          this.activeModel = false;
          this.getData();
