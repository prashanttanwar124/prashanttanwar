  ...
  <div class>
    <div class="uk-flex-middle uk-margin-medium-bottom" uk-grid>
      ...
      <div class="uk-width-1-2 uk-flex-first">
        <div>
          <h4 class="uk-h4 uk-margin-remove">Client Table</h4>
        </div>
      </div>
    </div>
    ...
    <vs-dialog overflow-hidden not-center v-model="activeModel">
      ...
      <div class="uk-card-body uk-margin-small-top uk-width-large uk-margin-medium-top uk-padding-remove-top uk-padding-remove-bottom">
        <vs-input v-model="form.client_name" class="labelYes" label="Client Name" :readonly="deleteBtn">
        ...
        <div class="uk-margin-medium-top">
          <vs-input v-model="form.link" class="labelYes" label="Link" :readonly="deleteBtn">
            <template #message-danger>
...
export default {
  ...
  methods: {
    ...
    deleteData() {
      this.form
        .delete(`/data/client/${this.form.id}`)
        .then(res => {
          this.form.reset();
          this.activeModel = false;
          this.getData();
